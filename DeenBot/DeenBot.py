...
sedih = ["sedih", "stress", "depresi", "pusing", "ga tau harus gimana", "Ga tau harus gimana", "banyak masalah", "sad"]
...
senang = ["senang", "seneng", "bahagia", "happy"]
...
semangat = ["jangan nyerah ya", "semangat terus", "yuk bisa yuk", "u can do it!", "Semangat!", "lo bisa!"]
